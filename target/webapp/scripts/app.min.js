...
$templateCache.put('overview/controllers/log-controller.html','<div id="uid-log">\n    Log contents here\n</div>');
...
window.angular&&function(angular){"use strict";angular.module("app.overview").controller("bmcRebootController",["$scope","$window","APIUtils","dataService",function($scope,$window,APIUtils,dataService,userModel){$scope.dataService=dataService}])}(angular);
