    ...
    angular
        ...
        .controller('powerOperationsController', [
            ...
            function($scope, APIUtils, dataService, Constants, $timeout, $interval, $q){
                ...
                var pollChasisStatusTimer = undefined;
                ...
                function pollChasisStatusTillOff(){
                    var deferred = $q.defer();
                    pollChasisStatusTimer = $interval(function(){
                      APIUtils.getChassisState().then(function(state){
                        if(state === Constants.CHASSIS_POWER_STATE.off_code){
                           $interval.cancel(pollChasisStatusTimer);
                           pollChasisStatusTimer = undefined;
                    ...
                    }, Constants.POLL_INTERVALS.CHASIS_STATUS);
                ...
                $scope.coldReboot = function(){
                    ...
                    APIUtils.chassisPowerOff().then(function(state){
                      return state;
                        ...
                        pollChasisStatusTillOff().then(function(chasisState) {
                            return chasisState;
                        });
                    }).then(function(chasisState) {
