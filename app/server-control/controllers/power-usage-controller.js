    ...
    angular.module('app.serverControl').controller('powerUsageController', [
      ...
      function($scope, $window, APIUtils, $route, $q, toastService) {
        ...
        function loadPowerData() {
          ...
          const promises = [getPowerConsumptionPromise, getPowerCapPromise];
        ...
        $scope.setPowerCap = function() {
          ...
          $scope.loading = true;
          const promises = [setPowerCapValue(), setPowerCapEnable()];
        ...
        function setPowerCapValue() {
          return APIUtils.setPowerCap($scope.power_cap.PowerCap).then(
            function(data) {},
            function(error) {
              console.log(JSON.stringify(error));
              return $q.reject();
        ...
        function setPowerCapEnable() {
          return APIUtils.setPowerCapEnable(
