...
window.angular && (function(angular) {
  ...
  angular.module('app.configuration').controller('virtualMediaController', [
    ...
    function($scope, APIUtils, toastService, dataService, nbdServerService) {
      $scope.devices = [];
      $scope.loading = true;
      $scope.loadVirtualMedia = function() {
        APIUtils.getVmDevices()
            .then(function(response) {
              for (var i in response.data) {
                var vmDevice = {};
                vmDevice.deviceName = response.data[i].description;
                vmDevice.id = i;
            ...
            .catch(function(error) {
              ...
              toastService.error('Unable to get Virtual Media Devices');
            });
      };
...
function NBDServer(endpoint, file, id) {
  ...
  this._handle_cmd_read = function(req) {
    ...
    var blob = this.file.slice(req.offset_lsB, req.offset_lsB + req.length);
    ...
    reader.onload = (function(ev) {
                      ...
                      // String.fromCharCode.apply(null, new
