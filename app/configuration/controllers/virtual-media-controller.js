  ...
  this._handle_option = function(buf) {
    ...
    switch (opt) {
      ...
      default:
        ...
        var defaultResp = new ArrayBuffer(20);
        var defaultView = new DataView(resp, 0, 20);
        defaultView.setUint32(0, 0x0003e889);
        defaultView.setUint32(4, 0x045565a9);
        defaultView.setUint32(8, opt);
        defaultView.setUint32(12, NBD_REP_ERR_UNSUP);
        defaultView.setUint32(16, 0);
        this.ws.send(defaultResp);
    }
