                ...
                function ($scope, $window, APIUtils, dataService, $location, $anchorScroll, Constants, $interval, $q, $timeout) {
                    ...
                    function waitForDownload(){
                        ...
                        pollDownloadTimer = $interval(function(){
                            ...
                            APIUtils.getFirmwareList().then(function(firmwareList){
                                if(firmwareList.length === $scope.firmware_list.length + 1){
                                    $interval.cancel(pollDownloadTimer);
                                    pollDownloadTimer = undefined;
                                    deferred.resolve(firmwareList);
                                }
                            }, function(error){
                                $interval.cancel(pollDownloadTimer);
                                pollDownloadTimer = undefined;
                    ...
                    $scope.download = function(){
                        ...
                        APIUtils.getFirmwareList().then(function(firmwareList){
                            $scope.firmware_list = firmwareList;
                            return firmwareList;
                        }).then(function(firmwareList){
