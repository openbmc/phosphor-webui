...
window.angular && (function(angular) {
  ...
  angular.module('app.configuration').controller('firmwareController', [
    ...
    function(
      ...
      $scope.activateImage =
          function(imageId, imageVersion, imageType) {
                      ...
                      waitForDownload() {
                        ...
                        pollDownloadTimer = $interval(function() {
                          ...
                          if ((now.getTime() - startTime.getTime()) >=
                            ...
                            deferred.reject(
                                new Error(Constants.MESSAGES.POLL
                ...
                function(error) {
                  ...
                  $scope.downloading = false;
                          ...
                          $scope.changePriority =
                              function(imageId, imageVersion, from, to) {
