        ...
        $scope.setNetworkSettings = function() {
          ...
          if (!$scope.interface.DHCPEnabled) {
            ...
            for (var i in $scope.interface.ipv4.values) {
              if (
                !APIUtils.validIPV4IP($scope.interface.ipv4.values[i].Address)
              ) {
                toastService.error(
              ...
              if (
                !APIUtils.validIPV4IP($scope.interface.ipv4.values[i].Gateway)
              ) {
                toastService.error(
                  $scope.interface.ipv4.values[i].Address +
              ...
              if (
                $scope.interface.ipv4.values[i].updateAddress ||
