      ...
      $scope.setNetworkSettings = function() {
        ...
        if (promises.length) {
          $q.all(promises).finally(function() {
            ...
            // openbmc#3227,
            // reload the page which makes a REST call. Do this for all network
            // changes due to the possibility of a set network failing,
            // openbmc#1641, and to update dataService and old_interface to know
            // which data has changed if the user continues to edit network
            // settings.
            $timeout(function() {
              $route.reload();
            }, 4000);
