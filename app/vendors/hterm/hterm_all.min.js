...
lib
 ...
 lib.colors.x11ToCSS =
   ...
   function t(e) {
     return 1 == e.length ?
         parseInt(e + e, 16) :
         2 == e.length ? parseInt(e, 16) :
                         (3 == e.length && (e += e.substr(2)),
 ...
 lib.colors.mix =
     function(e, t, r) {
   for (var o = lib.colors.crackRGB(e), i = lib.colors.crackRGB(t), s = 0;
        4 > s; ++s) {
     var n = i[s] - o[s];
 ...
 lib.MessageManager.prototype.addMessages =
     function(e) {
   for (var t in e) {
     var r = e[t];
 ...
 lib.MessageManager.prototype.findAndLoadMessages =
     function(e, t) {
   function r(e) {
 ...
 lib.MessageManager.prototype.replaceReferences =
     lib.MessageManager.replaceReferences,
 lib.MessageManager.prototype.get =
     function(e, t, r) {
   var o;
   ...
   return t ? (t instanceof Array || (t = [t]), this.replaceReferences(o, t)) :
              o
 },
 lib.MessageManager.prototype.processI18nAttributes =
     function(e) {
   function t(e) {
   ...
   for (var r = e.querySelectorAll('[i18n]'), o = 0; o < r.length; o++) {
     ...
     if (s) {
       ...
       for (var a in s) {
         var l = s[a];
         '$' == l.substr(0, 1) &&
             (l = t(i.getAttribute(l.substr(1)) + '_' + a));
         var h = this.get(l);
 ...
 lib.PreferenceManager.Record =
     function(e, t) {
   this.name = e, this.defaultValue = t, this.currentValue = this.DEFAULT_VALUE,
   this.observers = []
 },
 lib.PreferenceManager.Record.prototype.DEFAULT_VALUE =
     lib.PreferenceManager.prototype.DEFAULT_VALUE,
 lib.PreferenceManager.Record.prototype.addObserver =
     function(e) {
   this.observers.push(e)
 },
 lib.PreferenceManager.Record.prototype.removeObserver =
     function(e) {
   var t = this.observers.indexOf(e);
   t >= 0 && this.observers.splice(t, 1)
 },
 lib.PreferenceManager.Record.prototype.get =
     function() {
 ...
 lib.PreferenceManager.prototype.definePreference =
     function(e, t, r) {
 ...
 lib.PreferenceManager.prototype.notifyAll =
     function() {
   for (var e in this.prefRecords_) this.notifyChange_(e)
 },
 lib.PreferenceManager.prototype.notifyChange_ =
     function(e) {
 ...
 lib.PreferenceManager.prototype.removeChild =
     function(e, t) {
 ...
 lib.PreferenceManager.prototype.getChild =
     function(e, t, r) {
 ...
 lib.PreferenceManager.diffChildLists =
     function(e, t) {
 ...
 lib.PreferenceManager.prototype.syncChildList =
     function(e, t) {
   function r() {
     0 == --o && t && t()
   }
 ...
 lib.PreferenceManager.prototype.reset =
     function(e) {
   var t = this.prefRecords_[e];
   if (!t) throw new Error('Unknown preference: ' + e);
 ...
 lib.PreferenceManager.prototype.resetAll =
     function() {
   var e = [];
 ...
 lib.PreferenceManager.prototype.diff =
     function(e, t) {
 ...
 lib.PreferenceManager.prototype.changeDefault =
     function(e, t) {
 ...
 lib.PreferenceManager.prototype.changeDefaults =
     function(e) {
   for (var t in e) this.changeDefault(t, e[t])
 },
 lib.PreferenceManager.prototype.set =
     function(e, t) {
   var r = this.prefRecords_[e];
   if (!r) throw new Error('Unknown preference: ' + e);
   var o = r.get();
 ...
 lib.PreferenceManager.prototype.get =
     function(e) {
   var t = this.prefRecords_[e];
   if (!t) throw new Error('Unknown preference: ' + e);
   return t.get()
 },
 lib.PreferenceManager.prototype.exportAsJson =
     function() {
   var e = {};
 ...
 lib.PreferenceManager.prototype.importFromJson =
     function(e) {
   for (var t in e)
     if (t in this.childLists_)
 ...
 lib.PreferenceManager.prototype.onChildListChange_ =
     function(e) {
 ...
 lib.Storage.Chrome.prototype.onChanged_ =
     function(e, t) {
   if (chrome.storage[t] == this.storage_)
     for (var r = 0; r < this.observers_.length; r++) this.observers_[r](e)
 },
 lib.Storage.Chrome.prototype.addObserver =
     function(e) {
   this.observers_.push(e)
 },
 lib.Storage.Chrome.prototype.removeObserver =
     function(e) {
   var t = this.observers_.indexOf(e);
   -1 != t && this.observers_.splice(t, 1)
 },
 lib.Storage.Chrome.prototype.clear =
     function(e) {
   this.storage_.clear(), e && setTimeout(e, 0)
 },
 lib.Storage.Chrome.prototype.getItem =
     function(e, t) {
   this.storage_.get(e, t)
 },
 lib.Storage.Chrome.prototype.getItems =
     function(e, t) {
   this.storage_.get(e, t)
 },
 lib.Storage.Chrome.prototype.setItem =
     function(e, t, r) {
   var o = {};
   o[e] = t, this.storage_.set(o, r)
 },
 lib.Storage.Chrome.prototype.setItems =
     function(e, t) {
   this.storage_.set(e, t)
 },
 lib.Storage.Chrome.prototype.removeItem =
     function(e, t) {
   this.storage_.remove(e, t)
 },
 lib.Storage.Chrome.prototype.removeItems =
     function(e, t) {
   this.storage_.remove(e, t)
 },
 lib.Storage.Local =
 ...
 lib.Storage.Local.prototype.onStorage_ =
     function(e) {
 ...
 lib.Storage.Local.prototype.addObserver =
     function(e) {
   this.observers_.push(e)
 },
 lib.Storage.Local.prototype.removeObserver =
     function(e) {
   var t = this.observers_.indexOf(e);
   -1 != t && this.observers_.splice(t, 1)
 },
 lib.Storage.Local.prototype.clear =
     function(e) {
   this.storage_.clear(), e && setTimeout(e, 0)
 },
 lib.Storage.Local.prototype.getItem =
     function(e, t) {
 ...
 lib.Storage.Local.prototype.getItems =
     function(e, t) {
 ...
 lib.Storage.Memory.prototype.addObserver =
     function(e) {
   this.observers_.push(e)
 },
 lib.Storage.Memory.prototype.removeObserver =
     function(e) {
   var t = this.observers_.indexOf(e);
   -1 != t && this.observers_.splice(t, 1)
 },
 lib.Storage.Memory.prototype.clear =
     function(e) {
   var t = {};
 ...
 lib.Storage.Memory.prototype.getItem =
     function(e, t) {
 ...
 lib.Storage.Memory.prototype.getItems =
     function(e, t) {
   for (var r = {}, o = e.length - 1; o >= 0; o--) {
 ...
 lib.Storage.Memory.prototype.setItem =
     function(e, t, r) {
 ...
 lib.Storage.Memory.prototype.setItems =
     function(e, t) {
   var r = {};
   for (var o in e)
 ...
 lib.Storage.Memory.prototype.removeItem =
     function(e, t) {
   delete this.storage_[e], t && setTimeout(t, 0)
 },
 lib.Storage.Memory.prototype.removeItems =
     function(e, t) {
 ...
 lib.TestManager.Suite.disableTest =
     function(e, t) {
   if (e in this.testMap_) throw 'Duplicate test name: ' + e;
   var r = new lib.TestManager.Test(this, e, t);
   console.log('Disabled test: ' + r.fullName)
 },
 lib.TestManager.Suite.getTest =
     function(e) {
   return this.testMap_[e]
 },
 lib.TestManager.Suite.getTestList =
     function() {
   return this.testList_
 },
 lib.TestManager.Suite.prototype.setDefaults =
     function(e, t) {
 ...
 lib.TestManager.TestRun =
     function(e, t) {
   this.testManager = e, this.log = e.log, this.cx = t || {},
   this.failures = [], this.passes = [], this.startDate = null,
   this.duration = null, this.currentResult = null, this.maxFailures = 0,
   this.panic = !1, this.testQueue_ = []
 },
 lib.TestManager.TestRun.prototype.ALL_TESTS = new String('<all-tests>'),
 lib.TestManager.TestRun.prototype.selectTest =
     function(e) {
   this.testQueue_.push(e)
 },
 lib.TestManager.TestRun.prototype.selectSuite =
     function(e, t) {
 ...
 lib.TestManager.TestRun.prototype.selectPattern =
     function(e) {
 ...
 lib.TestManager.TestRun.prototype.onUncaughtException_ =
     function(e, t, r) {
 ...
 lib.TestManager.TestRun.prototype.onTestRunComplete_ =
     function(e) {
   return e ?
   ...
   if (this.log.popPrefix(),
     ...
     if (e.status != e.PASSED)
       return this.log.println(
                  'Unknown result status: ' + e.test.fullName + ': ' +
                  e.status),
              this.panic = !0;
     this.passes.push(e)
   }
 ...
 lib.TestManager.TestRun.prototype.onResultReComplete =
     function(e, t) {
 ...
 lib.TestManager.TestRun.prototype.runNextTest_ =
     function() {
 ...
 lib.TestManager.TestRun.prototype.run =
     function() {
 ...
 lib.TestManager.TestRun.prototype.msToSeconds_ =
     function(e) {
   var t = (e / 1e3).toFixed(2);
   return t + 's'
 },
 lib.TestManager.TestRun.prototype.summarize =
     function() {
 ...
 lib.TestManager.Result.TestComplete =
     function(e) {
   this.result = e
 },
 ...
 lib.TestManager.Result.prototype.run =
     function() {
 ...
 lib.TestManager.Result.prototype.expectErrorMessage =
     function(e) {
   this.expectedErrorMessage_ = e
 },
 lib.TestManager.Result.prototype.onTimeout_ =
     function() {
   this.timeout_ = null,
   this.status == this.PENDING &&
       (this.println('Test timed out.'), this.completeTest_(this.FAILED, !1))
 },
 lib.TestManager.Result.prototype.requestTime =
     function(e) {
   this.timeout_ && clearTimeout(this.timeout_),
       this.timeout_ = setTimeout(this.onTimeout_.bind(this), e)
 },
 lib.TestManager.Result.prototype.completeTest_ =
     function(e, t) {
 ...
 lib.TestManager.Result.prototype.arrayEQ_ =
     function(e, t) {
   if (!e || !t) return !e && !t;
 ...
 lib.TestManager.Result.prototype.assertEQ =
     function(e, t, r) {
   function o(e) {
 ...
 lib.TestManager.Result.prototype.assert =
     function(e, t) {
   if (e !== !0) {
     var r = t ? '[' + t + ']' : '';
     this.fail(
 ...
 lib.TestManager.Result.prototype.getCallerLocation_ =
     function(e) {
   try {
     throw new Error
   } catch (t) {
 ...
 lib.TestManager.Result.prototype.println =
     function(e) {
   this.testRun.log.println(e)
 },
 lib.TestManager.Result.prototype.fail =
     function(e) {
   arguments.length && this.println(e), this.completeTest_(this.FAILED, !0)
 },
 lib.TestManager.Result.prototype.pass =
     function() {
 ...
 lib.UTF8Decoder.prototype.decode =
     function(e) {
 ...
 lib.wc.combining =
     [
       [768, 879],       [1155, 1158],     [1160, 1161],     [1425, 1469],
       [1471, 1471],     [1473, 1474],     [1476, 1477],     [1479, 1479],
       [1536, 1539],     [1552, 1557],     [1611, 1630],     [1648, 1648],
       [1750, 1764],     [1767, 1768],     [1770, 1773],     [1807, 1807],
       [1809, 1809],     [1840, 1866],     [1958, 1968],     [2027, 2035],
       [2305, 2306],     [2364, 2364],     [2369, 2376],     [2381, 2381],
       [2385, 2388],     [2402, 2403],     [2433, 2433],     [2492, 2492],
       [2497, 2500],     [2509, 2509],     [2530, 2531],     [2561, 2562],
       [2620, 2620],     [2625, 2626],     [2631, 2632],     [2635, 2637],
       [2672, 2673],     [2689, 2690],     [2748, 2748],     [2753, 2757],
       [2759, 2760],     [2765, 2765],     [2786, 2787],     [2817, 2817],
       [2876, 2876],     [2879, 2879],     [2881, 2883],     [2893, 2893],
       [2902, 2902],     [2946, 2946],     [3008, 3008],     [3021, 3021],
       [3134, 3136],     [3142, 3144],     [3146, 3149],     [3157, 3158],
       [3260, 3260],     [3263, 3263],     [3270, 3270],     [3276, 3277],
       [3298, 3299],     [3393, 3395],     [3405, 3405],     [3530, 3530],
       [3538, 3540],     [3542, 3542],     [3633, 3633],     [3636, 3642],
       [3655, 3662],     [3761, 3761],     [3764, 3769],     [3771, 3772],
       [3784, 3789],     [3864, 3865],     [3893, 3893],     [3895, 3895],
       [3897, 3897],     [3953, 3966],     [3968, 3972],     [3974, 3975],
       [3984, 3991],     [3993, 4028],     [4038, 4038],     [4141, 4144],
       [4146, 4146],     [4150, 4151],     [4153, 4153],     [4184, 4185],
       [4448, 4607],     [4959, 4959],     [5906, 5908],     [5938, 5940],
       [5970, 5971],     [6002, 6003],     [6068, 6069],     [6071, 6077],
       [6086, 6086],     [6089, 6099],     [6109, 6109],     [6155, 6157],
       [6313, 6313],     [6432, 6434],     [6439, 6440],     [6450, 6450],
       [6457, 6459],     [6679, 6680],     [6912, 6915],     [6964, 6964],
       [6966, 6970],     [6972, 6972],     [6978, 6978],     [7019, 7027],
       [7616, 7626],     [7678, 7679],     [8203, 8207],     [8234, 8238],
       [8288, 8291],     [8298, 8303],     [8400, 8431],     [12330, 12335],
       [12441, 12442],   [43014, 43014],   [43019, 43019],   [43045, 43046],
       [64286, 64286],   [65024, 65039],   [65056, 65059],   [65279, 65279],
       [65529, 65531],   [68097, 68099],   [68101, 68102],   [68108, 68111],
       [68152, 68154],   [68159, 68159],   [119143, 119145], [119155, 119170],
       [119173, 119179], [119210, 119213], [119362, 119364], [917505, 917505],
       [917536, 917631], [917760, 917999]
     ],
 lib.wc.ambiguous =
     [
       [161, 161],     [164, 164],     [167, 168],        [170, 170],
       [174, 174],     [176, 180],     [182, 186],        [188, 191],
       [198, 198],     [208, 208],     [215, 216],        [222, 225],
       [230, 230],     [232, 234],     [236, 237],        [240, 240],
       [242, 243],     [247, 250],     [252, 252],        [254, 254],
       [257, 257],     [273, 273],     [275, 275],        [283, 283],
       [294, 295],     [299, 299],     [305, 307],        [312, 312],
       [319, 322],     [324, 324],     [328, 331],        [333, 333],
       [338, 339],     [358, 359],     [363, 363],        [462, 462],
       [464, 464],     [466, 466],     [468, 468],        [470, 470],
       [472, 472],     [474, 474],     [476, 476],        [593, 593],
       [609, 609],     [708, 708],     [711, 711],        [713, 715],
       [717, 717],     [720, 720],     [728, 731],        [733, 733],
       [735, 735],     [913, 929],     [931, 937],        [945, 961],
       [963, 969],     [1025, 1025],   [1040, 1103],      [1105, 1105],
       [8208, 8208],   [8211, 8214],   [8216, 8217],      [8220, 8221],
       [8224, 8226],   [8228, 8231],   [8240, 8240],      [8242, 8243],
       [8245, 8245],   [8251, 8251],   [8254, 8254],      [8308, 8308],
       [8319, 8319],   [8321, 8324],   [8364, 8364],      [8451, 8451],
       [8453, 8453],   [8457, 8457],   [8467, 8467],      [8470, 8470],
       [8481, 8482],   [8486, 8486],   [8491, 8491],      [8531, 8532],
       [8539, 8542],   [8544, 8555],   [8560, 8569],      [8592, 8601],
       [8632, 8633],   [8658, 8658],   [8660, 8660],      [8679, 8679],
       [8704, 8704],   [8706, 8707],   [8711, 8712],      [8715, 8715],
       [8719, 8719],   [8721, 8721],   [8725, 8725],      [8730, 8730],
       [8733, 8736],   [8739, 8739],   [8741, 8741],      [8743, 8748],
       [8750, 8750],   [8756, 8759],   [8764, 8765],      [8776, 8776],
       [8780, 8780],   [8786, 8786],   [8800, 8801],      [8804, 8807],
       [8810, 8811],   [8814, 8815],   [8834, 8835],      [8838, 8839],
       [8853, 8853],   [8857, 8857],   [8869, 8869],      [8895, 8895],
       [8978, 8978],   [9312, 9449],   [9451, 9547],      [9552, 9587],
       [9600, 9615],   [9618, 9621],   [9632, 9633],      [9635, 9641],
       [9650, 9651],   [9654, 9655],   [9660, 9661],      [9664, 9665],
       [9670, 9672],   [9675, 9675],   [9678, 9681],      [9698, 9701],
       [9711, 9711],   [9733, 9734],   [9737, 9737],      [9742, 9743],
       [9748, 9749],   [9756, 9756],   [9758, 9758],      [9792, 9792],
       [9794, 9794],   [9824, 9825],   [9827, 9829],      [9831, 9834],
       [9836, 9837],   [9839, 9839],   [10045, 10045],    [10102, 10111],
       [57344, 63743], [65533, 65533], [983040, 1048573], [1048576, 1114109]
     ],
 lib.wc.isSpace =
     function(e) {
 ...
 lib.wc.charWidthDisregardAmbiguous =
     function(e) {
   return 0 === e ?
       lib.wc.nulWidth :
 ...
 lib.wc.charWidthRegardAmbiguous =
     function(e) {
