    ...
    function($scope, APIUtils, $q, toastService) {
      ...
      function setUseSSL(ldapProperties) {
        ...
        if (ldapProperties.LDAP.ServiceEnabled) {
          ...
          isSSL =
              isURISecure(ldapProperties.ActiveDirectory.ServiceAddresses[0]);
        }
        return isSSL;
      }
      ...
      function setBaseDistinguishedNames(ldapProperties) {
        ...
        if (ldapProperties.LDAP.ServiceEnabled) {
          basedDisguishedNames = ldapProperties.LDAP.LDAPService.SearchSettings
                                     .BaseDistinguishedNames;
        } else if (ldapProperties.ActiveDirectory.ServiceEnabled) {
          basedDisguishedNames = ldapProperties.ActiveDirectory.LDAPService
      ...
      function setGroupsAttribute(ldapProperties) {
        ...
        if (ldapProperties.LDAP.ServiceEnabled) {
          groupsAttribute =
              ldapProperties.LDAP.LDAPService.SearchSettings.GroupsAttribute;
        } else if (ldapProperties.ActiveDirectory.ServiceEnabled) {
          groupsAttribute = ldapProperties.ActiveDirectory.LDAPService
      ...
      function setUsernameAttribute(ldapProperties) {
        ...
        if (ldapProperties.LDAP.ServiceEnabled) {
          userNameAttribute =
              ldapProperties.LDAP.LDAPService.SearchSettings.UsernameAttribute;
        } else if (ldapProperties.ActiveDirectory.ServiceEnabled) {
          userNameAttribute = ldapProperties.ActiveDirectory.LDAPService
      ...
      function setAuthenticationType(ldapProperties) {
        ...
        if (ldapProperties.LDAP.ServiceEnabled) {
          authenticationType =
              ldapProperties.LDAP.Authentication.AuthenticationType;
        } else if (ldapProperties.ActiveDirectory.ServiceEnabled) {
          authenticationType =
              ldapProperties.ActiveDirectory.Authentication.AuthenticationType;
        }
      ...
      function setRoleGroups(ldapProperties) {
        ...
        if (ldapProperties.LDAP.ServiceEnabled) {
          ...
          roleGroups = ldapProperties.ActiveDirectory.RemoteRoleMapping;
        }
