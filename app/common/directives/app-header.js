          ...
          controller: [
            ...
            function(
              ...
              ws.onmessage = function(evt) {
                ...
                if (
                  content.hasOwnProperty('properties') &&
              ...
              $scope.loadServerStatus = function() {
                ...
                APIUtils.getHostState().then(
                  function(status) {
                    if (
                      status == 'xyz.openbmc_project.State.Host.HostState.Off'
                    ) {
              ...
              $scope.refresh = function() {
                ...
                const myEl = angular.element(
                  document.querySelector('.header__refresh')
                );
                myEl.addClass('flash');
                setTimeout(function() {
              ...
              const loginListener = $rootScope.$on('user-logged-in', function(
                event,
                arg
              ) {
                loadData();
