...
window.angular && (function(angular) {
  ...
  angular.module('app.common.services', []).service('Constants', function() {
    return {
      ...
      FIRMWARE: {
        ACTIVATE_FIRMWARE: 'xyz.openbmc_project.Software.Activation' +
      ...
      MESSAGES: {
        POLL: {
          CHASSIS_OFF_TIMEOUT:
              'Time out. Chassis did not reach power off state in allotted ' +
              'time.',
          HOST_ON_TIMEOUT:
        ...
        ERROR_MODAL: {
          ...
          DESCRIPTION:
              'Oops! An unexpected error occurred. Record specific details ' +
              'of the issue, then contact your company support services.',
        },
