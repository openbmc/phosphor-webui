    ...
    function(Constants) {
      ...
      this.getServerId =
        ...
        if (sessionStorage.getItem(Constants.API_CREDENTIALS.host_storage_key) !== null) {
          ...
          return Constants.API_CREDENTIALS.default_protocol + '://' + window.location.hostname +
