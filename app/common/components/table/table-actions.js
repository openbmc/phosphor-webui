window.angular && (function(angular) {
  ...
  /**
   *
   * bmcTableActions Component
   *
   * To use:
   * The <bmc-table-actions> component expects an 'actions' attribute
  ...
  /**
   * Register bmcTableActions component
   */
  angular.module('app.common.components').component('bmcTableActions', {
    controller,
    template,
