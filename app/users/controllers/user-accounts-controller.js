    ...
    angular.module('app.users').controller('userAccountsController', [
      ...
      function($scope, $q, APIUtils, toastService) {
        ...
        $scope.saveAllValues = function() {
          ...
          APIUtils.saveUserAccountProperties(
            data['AccountLockoutDuration'],
            data['AccountLockoutThreshold']
          )
            .then(
        ...
        $scope.createNewUser = function() {
          ...
          if (
            $scope.selectedUser.Password !== $scope.selectedUser.VerifyPassword
          ) {
          ...
          const user = $scope.selectedUser.UserName;
          const passwd = $scope.selectedUser.Password;
          const role = $scope.selectedUser.RoleId;
          let enabled = false;
        ...
        $scope.updateUserInfo = function() {
          ...
          const data = {};
          if (
            $scope.selectedUser.UserName !== $scope.selectedUser.CurrentUserName
          ) {
        ...
        $scope.doesUserExist = function() {
          for (const i in $scope.users) {
            ...
            if (
              $scope.users[i].UserName === $scope.selectedUser.UserName &&
